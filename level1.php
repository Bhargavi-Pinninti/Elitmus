...
<html>
  <head>
    ...
    <style>
        html{
            background-image: url(images/level1.jpeg);
        }
...
@keyframes timer-anim {
  ...
  <body onload="startTimer()">
    ...
    ?> </h2>
          ...
          <button id="next" onclick="location.href='level2.php'" class="restart" style="border-left:800px;">2nd Floor</button>
          </div>
...
var all_questions = [{
  question_string: "A man was murdered in his office.The suspects are Ericson, Maggi, Jason, Benny, Sona, Patick.A calendar found near the man has blood written 6, 4, 9, 10, 11.Who is the killer?",
  choices: {
    correct: "Jason",
    wrong: ["Maggi", "Benny", "Sona"]
  }
}, {
  question_string: "One rabbit saw 6 elephants while going towards River. Every elephant saw 2 monkeys are going towards river. Every monkey holds one tortoice in their hands.How many animals are going towards the river?",
  choices: {
    correct: "5",
    wrong: ["14", "7", "9"]
  }
}, {
  question_string: "They come out at night without being called and are lost in the day without being stolen. What are they?",
  choices: {
    correct: "Stars",
    wrong: ["Lights", "Bats", "Flights"]
  }
}, {
  question_string: 'Poor people have it.Rich people need it.If you eat it you die.What is it?',
  choices: {
    correct: "Nothing",
    wrong: ["Money", "Brain", "Luxury items"]
  }
}];
...
Quiz.prototype.render = function(container) {
    ...
    $('#submit-button').click(function() {
        ...
        xhr.open("POST", "level1_score.php", true);
