...
@keyframes timer-anim {
  ...
  <body onload="startTimer()">
    ...
    ?> </h2>
          ...
          <button id="next" onclick="location.href='level3.php'" class="restart" style="border-left:800px;">3rd Floor</button>
          </div>
        </div>
...
var all_questions = [{
  question_string: "In a certain code FIRE is coded as DGPC. What will be the last letter of the coded word for SHOT.?",
  choices: {
    correct: "R",
    wrong: ["Q", "S", "P"]
  }
}, {
  question_string: "If TOUR is written in a certain code as 1234, CLEAR as 56784 and SPARE as 90847, what will be the 5th digit for SCULPTURE in the same code ?",
  choices: {
    correct: "0",
    wrong: ["3", "4", "6"]
  }
}, {
  question_string: "If in a certain language PROSE is coded as PPOQE, how is LIGHT coded in that code?",
  choices: {
    correct: "LGGFT",
    wrong: ["LIGFT", "LGGHT", "LLGFE"]
  }
}, {
  question_string: 'If in a certain language SISTER is coded as 535301, UNCLE is coded as 84670 and BOY as 129, how son is coded?',
  choices: {
    correct: "524",
    wrong: ["783", "872", "346"]
  }
...
Quiz.prototype.render = function(container) {
    ...
    $('#submit-button').click(function() {
        ...
        xhr.open("POST", "level2_score.php", true);
